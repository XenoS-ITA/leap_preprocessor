...
function editMessage(user)if type(user) ~= "User" then error('user: must be (User) but got '..type(user), 2) end; _leap_internal_using_operator("HaveRightsTo","editMessage")
